...
conv2_sep_real <- function(X, kernel) {
    .Call(`_zernike_conv2_sep_real`, X, kernel)
}
...
conv2_sep_complex <- function(X, kernel) {
    .Call(`_zernike_conv2_sep_complex`, X, kernel)
}
